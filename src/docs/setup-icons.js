// Icon-registry setup shared between docs/main.js (docs.html) and test.js (index.html).
//
...
// --- Heroicons (per-icon imports, tree-shakable) ---
...
/** Returns the createNbIcons() plugin configured for all four showcase providers. */
export function buildIconsPlugin() {
    return createNbIcons({
